...
interface AddApi {
    ...
    suspend fun addGifticonImg(@Part files:Array<MultipartBody.Part>): List<AddImgInfoResult>

    @POST("files/register_gifticon")
    suspend fun addGifticonImgInfo(@Body imgInfo: Array<AddImgInfo>): List<AddImgInfoResult>
}